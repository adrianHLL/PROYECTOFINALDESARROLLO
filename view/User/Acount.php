    ...
    <div class="row">
      <div class="col-md-12 order-md-1"><br><br><br><br>
        ...
        <form class="needs-validation" action="Acount-edit.php" method="POST" novalidate>
          ...
          <button class="btn btn-sm btn-info " type="submit"><i class="fas fa-pencil-alt"></i> Editar Datos</button>
          <a href="" class="edit-pass" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-pencil-alt"></i> Cambiar Contraseña</a>
        </form>
      </div>
    </div>
    <br>
